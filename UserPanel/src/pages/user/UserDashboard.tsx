...
const UserDashboard: React.FC = () => {
  ...
  const [stats, setStats] = useState([
    ...
    { name: 'Upcoming Events', value: '0', icon: Calendar },
    { name: 'Announcements', value: '0', icon: MessageSquare },
  ]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-black rounded-2xl p-8 text-white">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-blue-100 mt-2">Continue your learning journey and explore new knowledge</p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Recent Activity */}
        <div className="bg-white text-black rounded-xl p-6 shadow border border-gray-200">
        ...
        <div className="bg-white text-black rounded-xl p-6 shadow border border-gray-200">
          ...
          <div className="grid grid-cols-2 gap-4">
            <a
              href="/user/notes"
              className="p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-blue-500 hover:bg-blue-50 transition-all group text-center"
            >
            ...
            <a
              href="/user/tips"
              className="p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-yellow-500 hover:bg-yellow-50 transition-all group text-center"
            >
            ...
            <a
              href="/user/events"
              className="p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-green-500 hover:bg-green-50 transition-all group text-center"
            >
            ...
            <a
              ...
              className="p-4 rounded-lg border-2 border-dashed border-gray-300 hover:border-purple-500 hover:bg-purple-50 transition-all group text-center"
            >
